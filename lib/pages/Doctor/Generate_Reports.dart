...
class Generate_Reports extends StatefulWidget {
  final String docId;
  final User user;
  ...
  @override
  State<Generate_Reports> createState() => _Generate_ReportsState();
}

class _Generate_ReportsState extends State<Generate_Reports> {
  bool isLoaded = false;
  ...
  late Widget bar =
      Text('Generate Reports', style: const TextStyle(color: Colors.white));
  bool pressed = false;
  ...
  SearchPatientByID(String Query) {
    for (var i in reports!) {
      reportIds.add(i.PatientID);
    }
    if (!reportIds.contains(Query)) {
                ...
                onPressed: () {
                  setState(() {
                    if (pressed == false) {
                      ...
                      this.bar = Text("Generate Reports");
                      pressed = false;
                    }
                  });
                }),
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) => Reports(
                              ...
                              patientName: patients![index].First_Name +
                                  ' ' +
